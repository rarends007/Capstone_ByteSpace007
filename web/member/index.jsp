                            ...
                            <form action="${pageContext.request.contextPath}/Member" method="post"
                                ...
                                <div class="make_post_input">
                                    ...
                                    <label for="file-upload" class="custom-file-upload"><img
                                            src="${pageContext.request.contextPath}/img/image.svg" /></label>
                                            ...
                                            <div class="comment_header">
                                                ...
                                                <form action="${pageContext.request.contextPath}/Member" method="POST">
                                                    ...
                                                    <button type="submit" value="Delete" class="delete_comment_btn">
                                                        <img src="${pageContext.request.contextPath}/img/delete.svg" />
                                                    </button>
                                        ...
                                        <c:forEach var="comment" items="${post.value.comments}">
                                            <div class="comment_container">
                                                ...
                                                <form action="${pageContext.request.contextPath}/Member" method="post">
                                                    ...
                                                    <button type="submit"
                                                        class="reply_btn button_primary">Reply</button>
                                                </form>
                                            </div>
                                        </c:forEach>
                                        <form action="${pageContext.request.contextPath}/Member" method="post">
                                            ...
                                            <div>
                                                <button type="submit" value="reply"
                                                    class="button_primary">Reply</button>
                                            </div>
                                        </form>
